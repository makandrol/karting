...
export const PHASE_CONFIGS: Record<string, { phases: PhaseConfig[] }> = {
  ...
  sprint: {
    phases: [
      ...
      { id: 'race_2_group_2', label: 'Гонка 2 · Група 2', shortLabel: 'Г2-2' },
      { id: 'race_2_group_3', label: 'Гонка 2 · Група 3', shortLabel: 'Г2-3' },
      { id: 'final_group_1', label: 'Фінал · Група 1', shortLabel: 'Фінал-1' },
      { id: 'final_group_2', label: 'Фінал · Група 2', shortLabel: 'Фінал-2' },
      { id: 'final_group_3', label: 'Фінал · Група 3', shortLabel: 'Фінал-3' },
    ],
  },
