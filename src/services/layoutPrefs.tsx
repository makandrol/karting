...
const HARDCODED_DEFAULTS: ServerDefaults = {
  ...
  sessionDetail: { sections: [{ id: 'replay', visible: true }, { id: 'timingTable', visible: true }, { id: 'track', visible: true }, { id: 'lapsByPilots', visible: true }, { id: 'marathonTeams', visible: true }, { id: 'marathonKarts', visible: true }], version: 1 },
